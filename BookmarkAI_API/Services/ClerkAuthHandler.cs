...
public class ClerkAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    private readonly IConfiguration _config;

    public ClerkAuthHandler(
    ...
    {
        var secretKey = _config["SECRET_API_KEY"];

        var authorizedParties = _config.GetSection("OAUTH_CLIENT_ID").Get<string[]>() 
                                ?? Array.Empty<string>();

        var audiences = _config.GetSection("Clerk:Audiences").Get<string[]>();
